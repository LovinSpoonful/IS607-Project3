...
for (i in 1:length(sources)){
  ...
  #set the column names of the dataset and remove the header lines
  n <- unlist(dat[3,])
  names(dat) = n  #
  dat <- dat[-1:-3,]
...
create a union table and push out each variant


we need to host a mysql database somewhere!
