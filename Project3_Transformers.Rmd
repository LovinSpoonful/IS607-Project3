...
#Also make a denormalized table with the analysis fields in it
sqlQuery(db,"DELETE FROM tbl_data;") # first truncate it
sSQL = "INSERT INTO tbl_data (skill_type_id, skill_id, source_id, skill_type_name, skill_name, source_name, source_description, rating) SELECT skill_type_id, skill_id, source_id, skill_type_name, skill_name, source_name, source_description, rating FROM vw_data;"
sqlQuery(db,sSQL)  
